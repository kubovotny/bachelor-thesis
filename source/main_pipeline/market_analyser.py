...
korelacie = df_filtered[['z_score', 'OIS_3M', 'DE2Y', 'STOXX50']].corr(method="spearman")
print("\nKorelačná matica:")
...
plot_relationship(df_filtered, 'z_score', 'OIS_3M', "Vplyv sentimentu na krátkodobé sadzby (OIS_3M)")
