...
\begin{figure}[htbp]
    ...
    \caption[Aggregate ECB sentiment, 1998--2025]{Aggregate \gls{ecb} sentiment, six-month centred moving average (unitless; $n = 289$ \gls{is}, $281$ \gls{qa} meetings). Shaded: $\pm1$ SD}
